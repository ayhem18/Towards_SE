...
grant_sa_permission_on_artifact_registry "${ARTIFACT_REPO_NAME}" "${DP_WORKER_SA_NAME}" "roles/artifactregistry.admin"
...
grant_sa_permission_on_bucket "${_DP_MAIN_BUCKET_NAME}" "${DP_WORKER_SA_NAME}" "roles/storage.objectAdmin"
